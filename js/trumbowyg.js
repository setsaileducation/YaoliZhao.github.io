...
(function($){
    ...
    var Trumbowyg = function(editorElem, opts){
        ...
        this.o = $.extend(true, {
            ...
            btns: ['viewHTML',
                        '|', 'formatting',
                        '|', $.trumbowyg.btnsG.design,
                        '|', 'link',
                        '|', 'insertImage',
                        '|', $.trumbowyg.btnsG.justify,
                        '|', $.trumbowyg.btnsG.lists,
                        '|', 'horizontalRule'],
            btnsAdd: [],
...
$(function(){
    $.trumbowyg.btnsG.test = ['bold','italic','underline','link'];
